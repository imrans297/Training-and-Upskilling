...
# This handles the AWS Load Balancer Controller for EKS

# IAM role for ALB Controller
resource "aws_iam_role" "alb_controller_role" {
  name = "imran-alb-controller-role"
...
resource "aws_iam_policy" "alb_controller_policy" {
  name        = "imran-alb-controller-policy"
...
data "tls_certificate" "eks_oidc" {
  url = aws_eks_cluster.imran_cluster.identity[0].oidc[0].issuer
}
