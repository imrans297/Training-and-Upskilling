# 13-ALB-Ingress-Context-Path-Routing: ALB Ingress Context Path Routing

## Overview
Master ALB Ingress Context Path Routing for production-ready EKS deployments.
...
## Directory Structure
```
13-ALB-Ingress-Context-Path-Routing/
